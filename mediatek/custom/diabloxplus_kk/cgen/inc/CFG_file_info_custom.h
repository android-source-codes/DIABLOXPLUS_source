...
//Modified jrd.lipeng for audio parameters customization.(PR708145)
#ifdef JRD_AUDIO_PARAMS_CUST
#include "../cfgdefault/CFG_Audio_Default_jrd_cust4Telus.h"
#endif
#ifdef __cplusplus
extern "C"
{
...
//Modified by jrd.lipeng for audio parameters customization.(PR708145)
#ifdef JRD_AUDIO_PARAMS_CUST
    const TCFG_FILE g_akCFG_File_Custom1[]=
    {
        ...
        { "/data/nvram/APCFG/APRDCL/AudioSub_CompFlt",   VER(AP_CFG_RDCL_FILE_AUDIOSUB_COMPFLT_LID), CFG_FILE_AUDIO_COMPFLT_REC_SIZE,
            CFG_FILE_AUDIOSUB_COMPFLT_REC_TOTAL, SIGNLE_DEFUALT_REC  ,    (char *)&audiosub_custom_default, DataReset , NULL
        },
    };
