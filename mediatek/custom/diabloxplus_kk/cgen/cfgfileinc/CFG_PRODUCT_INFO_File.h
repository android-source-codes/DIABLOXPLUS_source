...
//xiangrong add for fr572289 20140108 begin
...
typedef struct
{
	...
	unsigned char latam_imei_trigger[8];
	unsigned char tablet_sn[15];
	unsigned char ppe_kph[1];
	unsigned char uart_log[1];
	RESERVED_S reserved;
	
}PRODUCT_INFO;    //JRD TRACE STRUCT

//xiangrong.zhang add for fr572289 20140108 end
