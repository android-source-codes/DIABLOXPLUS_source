...
#define OV13850DB(fmt, arg...) 	   if(debugFlag) {printk("[JRD_CAM][OV13850]"  fmt, ##arg);}
#define OV13850DB_ERR(fmt, arg...)  {printk("[JRD_CAM_ERR][OV13850]"  fmt, ##arg);}

#ifdef OV13850_DEBUG_SOFIA
	#define OV13850DBSOFIA(fmt, arg...)  if(debugFlag) {printk("[JRD_CAM][OV13850]"  fmt, ##arg);}
#else
...
#define OV13850_ORIENTATION IMAGE_V_MIRROR //IMAGE_V_MIRROR
...
static int OV13850DebugLog(kal_bool value)
{
    printk(KERN_INFO "[JRD_CAM]OV13850DebugLog value is %d\n", value);
...
void OV13850CaptureSetting(void)
{
	...
	*/
	...
	OV13850_write_cmos_sensor(0x0302, 0x28);  
	OV13850_write_cmos_sensor(0x0303, 0x00);  
	OV13850_write_cmos_sensor(0x3612, 0x33);  
	OV13850_write_cmos_sensor(0x3614, 0x28);  
	...
	//;Windowing							  
	OV13850_write_cmos_sensor(0x3800, 0x00);  
	OV13850_write_cmos_sensor(0x3801, 0x14);  
	OV13850_write_cmos_sensor(0x3802, 0x00);  
	OV13850_write_cmos_sensor(0x3803, 0x0C);  
	OV13850_write_cmos_sensor(0x3804, 0x10);  
	OV13850_write_cmos_sensor(0x3805, 0x8B);  
	OV13850_write_cmos_sensor(0x3806, 0x0C);  
	OV13850_write_cmos_sensor(0x3807, 0x43);  
	OV13850_write_cmos_sensor(0x3808, 0x10);  
	OV13850_write_cmos_sensor(0x3809, 0x70);  
	OV13850_write_cmos_sensor(0x380A, 0x0C);  
	OV13850_write_cmos_sensor(0x380B, 0x30);  
	OV13850_write_cmos_sensor(0x380C, 0x12);  
	OV13850_write_cmos_sensor(0x380D, 0xC0);  
	OV13850_write_cmos_sensor(0x380E, 0x0d);  
	OV13850_write_cmos_sensor(0x380F, 0x00);  
	...
	OV13850_write_cmos_sensor(0x4020, 0x2 );  
	OV13850_write_cmos_sensor(0x4021, 0x3C);  
	OV13850_write_cmos_sensor(0x4022, 0xE );  
	OV13850_write_cmos_sensor(0x4023, 0x37);  
	OV13850_write_cmos_sensor(0x4024, 0xF );  
	OV13850_write_cmos_sensor(0x4025, 0x1C);  
	OV13850_write_cmos_sensor(0x4026, 0xF );  
	OV13850_write_cmos_sensor(0x4027, 0x1F);  
	OV13850_write_cmos_sensor(0x4601, 0x00);  
...
UINT32 OV13850GetSensorID(UINT32 *sensorID)
{
	...
	printk("[JRD_CAM][OV13850]OV13850GetSensorID enter :\n ");
	OV13850_WRITE_ID = OV13850MIPI_WRITE_ID;
	OV13850_write_cmos_sensor(0x0103,0x01);// Reset sensor
    mDELAY(10);
    ...
    do {
        *sensorID = (OV13850_read_cmos_sensor(0x300A)<<8)|OV13850_read_cmos_sensor(0x300B);
		printk("[JRD_CAM][OV13850]write id=%x, Sensor ID = 0x%04x\n", OV13850_WRITE_ID,*sensorID);
	...
	printk("[JRD_CAM]OV13850GetSensorID OV13850_WRITE_ID:%d\n", OV13850_WRITE_ID);
                                                                ...
                                                                UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
		...
		case SENSOR_FEATURE_DEBUG_LOG:
			OV13850DebugLog((kal_bool)*pFeatureData16); 
			break;
