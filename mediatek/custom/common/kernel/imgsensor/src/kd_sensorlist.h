...
UINT32 OV5648AFMIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 OV5648STMIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
/*addd by xiewei for diablox+ start */
...
/*addd by xiewei for diablox+ end */
...
//end
//begin cr 660791 add for sub camera driver by zhaozhen.wu@tcl.com
...
{
//add by xiewei for diablxo+ kk start
#if defined(IMX135TRULY_MIPI_RAW)
    {IMX135TRULY_SENSOR_ID, SENSOR_DRVNAME_IMX135TRULY_MIPI_RAW, IMX135TRULY_MIPI_RAW_SensorInit}, 
#endif
#if defined(OV13850_MIPI_RAW)
    {OV13850_SENSOR_ID, SENSOR_DRVNAME_OV13850_MIPI_RAW, OV13850_MIPI_RAW_SensorInit}, 
#endif
#if defined(IMX135SUNWIN_MIPI_RAW)
    {IMX135SUNWIN_SENSOR_ID, SENSOR_DRVNAME_IMX135SUNWIN_MIPI_RAW, IMX135SUNWIN_MIPI_RAW_SensorInit}, 
#endif
#if defined(IMX135BLX_MIPI_RAW)
    {IMX135BLX_SENSOR_ID, SENSOR_DRVNAME_IMX135BLX_MIPI_RAW, IMX135BLX_MIPI_RAW_SensorInit}, 
#endif
//add by xiewei for diablxo+ kk end
...
#endif
#if defined(OV5648AF_MIPI_RAW)
    {OV5648AFMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5648AF_MIPI_RAW, OV5648AFMIPISensorInit}, 
#endif
#if defined(OV5648ST_MIPI_RAW)
    {OV5648STMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5648ST_MIPI_RAW, OV5648STMIPISensorInit}, 
#endif
...
/*JRD BSP START*/
#if defined(HI258_YUV)
    {HI258_SENSOR_ID, SENSOR_DRVNAME_HI258_YUV, HI258_YUV_SensorInit},
#endif
/*JRD BSP END*/
//add for disabloxplus sub camera xiewei
    ...
    {GC2355MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2355_MIPI_RAW, GC2355MIPISensorInit}, 
#endif
//add for disabloxplus sub camera xiewei end

//begin wuzhaozhen add for eos-3g-kk
#if defined(OV8850_MIPI_RAW)
    {OV8850_SENSOR_ID, SENSOR_DRVNAME_OV8850_MIPI_RAW, OV8850_MIPI_RAW_SensorInit}, //zuoyong add for eclipse
#endif
#if defined(OV8858_MIPI_RAW)
    {OV8858_SENSOR_ID, SENSOR_DRVNAME_OV8858_MIPI_RAW, OV8858_MIPI_RAW_SensorInit}, //zuoyong add for eclipse
#endif
//end
//begin cr 660791 add for sub camera driver by zhaozhen.wu@tcl.com
