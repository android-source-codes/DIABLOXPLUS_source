...
//576470 LCD driver update by zhuqiang at 2014.2.8 begin
extern LCM_DRIVER hx8379a_soul45_vdo_drv; 
extern LCM_DRIVER ili9806c_soul45_byd_drv;
//576470 LCD driver update by zhuqiang at 2014.2.8 end

//576470 LCD driver update by lizhao at 2013.12.21 begin
extern LCM_DRIVER hx8379a_yaris5_kk_vdo_drv; 
extern LCM_DRIVER ili9806c_yaris5_kk_byd_drv;
//576470 LCD driver update by lizhao at 2013.12.21 end

extern LCM_DRIVER r69429_wuxga_dsi_cmd_lcm_drv;
extern LCM_DRIVER rm68210_hd720_dsi_ufoe_cmd_lcm_drv;
//576475 LCD driver update by baochangsheng at 2014.3.4 begin
extern LCM_DRIVER hx8389b_qhd_dsi_vdo_eclipse_lcm_drv;
extern LCM_DRIVER  nt35517_eclipse_tdt_drv;
//576475 LCD driver update by baochangsheng at 2014.3.4 end

extern LCM_DRIVER r63311_fhd_dsi_vedio_lcm_drv;
extern LCM_DRIVER nt35596_diabloxplus_hd_tdt_drv;
extern LCM_DRIVER hx8394a_truly_hd720_soul5_lcm_drv;
extern LCM_DRIVER hx8394a_tdt_hd720_soul5_lcm_drv;
extern LCM_DRIVER hx8389b_byd_qhd_soul5_lcm_drv;
extern LCM_DRIVER nt35517_tdt_qhd_soul5_lcm_drv;
extern LCM_DRIVER nt35695_diabloX_hd_drv;
extern LCM_DRIVER nt35521_hd720_cross_apac_lcm_drv;
extern LCM_DRIVER hx8394a_hd720_cross_apac_lcm_drv;

LCM_DRIVER* lcm_driver_list[] = 
{

#if defined(NT35521_HD720_CROSS_APAC)
    &nt35521_hd720_cross_apac_lcm_drv,
#endif

#if defined(HX8394A_HD720_CROSS_APAC)
    &hx8394a_hd720_cross_apac_lcm_drv,
#endif

#if defined(NT35695_DIABLOX)
        &nt35695_diabloX_hd_drv,
#endif

#if defined(HX8394A_TDT_HD720_SOUL5)
	&hx8394a_tdt_hd720_soul5_lcm_drv,
#endif

#if defined(HX8389B_BYD_QHD_SOUL5)
	&hx8389b_byd_qhd_soul5_lcm_drv,
#endif

#if defined(NT35517_TDT_QHD_SOUL5)
	&nt35517_tdt_qhd_soul5_lcm_drv,
#endif

#if defined(HX8394A_TRULY_HD720_SOUL5)
	&hx8394a_truly_hd720_soul5_lcm_drv,
#endif

#if defined(R63311_DIABLOX)
	&r63311_fhd_dsi_vedio_lcm_drv,
#endif

#if defined(NT35596_TDT_DIABLOXPLUS)
	&nt35596_diabloxplus_hd_tdt_drv,
#endif

//576475 LCD driver update by baochangsheng at 2014.3.4 begin
#if defined(NT35517_ECLIPSE_TDT)
         &nt35517_eclipse_tdt_drv,
#endif

#if defined(HX8389B_QHD_DSI_VDO_ECLIPSE)
         &hx8389b_qhd_dsi_vdo_eclipse_lcm_drv,
#endif
//576475 LCD driver update by baochangsheng at 2014.3.4 end

//576470 LCD driver update by zhuqiang at 2014.2.8 begin
#if defined(ILI9806C_DSI_VDO_SOUL45)
	&ili9806c_soul45_byd_drv,
#endif

#if defined(HX8379A_DSI_VDO_SOUL45)
	&hx8379a_soul45_vdo_drv,
#endif
//576470 LCD driver update by zhuqiang at 2014.2.8 end


//576470 LCD driver update by lizhao at 2013.12.21 begin
#if defined(ILI9806C_YARIS5_KK)
	&ili9806c_yaris5_kk_byd_drv,
#endif

#if defined(HX8379A_YARIS5_KK)
	&hx8379a_yaris5_kk_vdo_drv,
#endif
//576470 LCD driver update by lizhao at 2013.12.21 end
