...
#define RAW_INFO(_id, name, getCalData)\
    ...
    extern UINT32 CAM_CALGetCalData_OV5648AF(UINT32* pGetSensorCalData);
#endif

#if defined(OV5648ST_MIPI_RAW)
    extern UINT32 CAM_CALGetCalData_OV5648ST(UINT32* pGetSensorCalData);
#endif

#if defined(IMX135TRULY_MIPI_RAW)
extern UINT32 CAM_CALGetCalData_IMX135TRULYRAW(UINT32* pGetSensorCalData);
#endif

//add by xiewei for diablox+ 
#if defined(IMX135BLX_MIPI_RAW)
extern UINT32 CAM_CALGetCalData_IMX135BLXRAW(UINT32* pGetSensorCalData);
#endif

#if defined(IMX135SUNWIN_MIPI_RAW)
extern UINT32 CAM_CALGetCalData_IMX135SUNWINRAW(UINT32* pGetSensorCalData);
#endif

//MSDK_SENSOR_INIT_FUNCTION_STRUCT SensorList[MAX_NUM_OF_SUPPORT_SENSOR] =
MSDK_SENSOR_INIT_FUNCTION_STRUCT SensorList[] =
{
//add by xiewei for diabalox+ kk start
#if defined(IMX135TRULY_MIPI_RAW)
	RAW_INFO(IMX135TRULY_SENSOR_ID, SENSOR_DRVNAME_IMX135TRULY_MIPI_RAW,CAM_CALGetCalData_IMX135TRULYRAW), 
#endif
#if defined(OV13850_MIPI_RAW)
	RAW_INFO(OV13850_SENSOR_ID, SENSOR_DRVNAME_OV13850_MIPI_RAW,NULL),
#endif
#if defined(IMX135SUNWIN_MIPI_RAW)
	RAW_INFO(IMX135SUNWIN_SENSOR_ID, SENSOR_DRVNAME_IMX135SUNWIN_MIPI_RAW,NULL), 
#endif
#if defined(IMX135BLX_MIPI_RAW)
	RAW_INFO(IMX135BLX_SENSOR_ID, SENSOR_DRVNAME_IMX135BLX_MIPI_RAW,CAM_CALGetCalData_IMX135BLXRAW), 
#endif
//add by xiewei for diabalox+ kk end
...
#endif
#if defined(OV5648AF_MIPI_RAW)
    RAW_INFO(OV5648AFMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5648AF_MIPI_RAW, CAM_CALGetCalData_OV5648AF/*NULL*/), 
#endif
#if defined(OV8850_MIPI_RAW)//wuzhaozhen add for eos-3g-kk
    RAW_INFO(OV8850_SENSOR_ID, SENSOR_DRVNAME_OV8850_MIPI_RAW,NULL), 
#endif
#if defined(OV8858_MIPI_RAW)//wuzhaozhen add for eos-3g-kk
    RAW_INFO(OV8858_SENSOR_ID, SENSOR_DRVNAME_OV8858_MIPI_RAW,NULL), 
#endif
//begin cr660791 add for sub camera driver by zhaozhen.wu@tcl.com
#if defined(S5K5E2YA_MIPI_RAW)
    RAW_INFO(S5K5E2YA_SENSOR_ID, SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW, NULL), 
#endif
//end
#if defined(OV5648ST_MIPI_RAW)
    RAW_INFO(OV5648STMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5648ST_MIPI_RAW, CAM_CALGetCalData_OV5648ST/*NULL*/), 
#endif

/*added for diabloxplus sub camera xiewei@tcl  start*/
	...
	RAW_INFO(GC2355MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2355_MIPI_RAW, NULL), 
#endif
/*added for diabloxplus sub camera xiewei@tcl end*/
