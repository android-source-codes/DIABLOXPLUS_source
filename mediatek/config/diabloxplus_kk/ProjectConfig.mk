...
CUSTOM_HAL_IMGSENSOR= ov13850_mipi_raw imx135truly_mipi_raw imx135sunwin_mipi_raw imx135blx_mipi_raw imx132_mipi_raw ov2680_mipi_raw gc2355_mipi_raw

# = CUSTOM_HAL_MAIN_LENS +CUSTOM_HAL_MAIN_BACKUP_LENS + CUSTOM_HAL_SUB_LENS + CUSTOM_HAL_SUB_BACKUP_LENS
CUSTOM_HAL_LENS= ak7345af dw9718af dw9714a dw9714asunwin dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR=

# lens driver config for main camera (2nd solution)
CUSTOM_HAL_MAIN_BACKUP_LENS= dw9718af dw9714a dw9714asunwin
...
CUSTOM_HAL_MAIN_IMGSENSOR= imx135truly_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = ov13850_mipi_raw imx135sunwin_mipi_raw imx135blx_mipi_raw

# lens driver config for main camera
CUSTOM_HAL_MAIN_LENS= ak7345af

# M-sensor hal layer library including daemon
CUSTOM_HAL_MSENSORLIB=mmc328x akm8975 ami304 yamaha530 mag3110 akmd8963 bmm050 bmx050 mc6420 mmc3416x s62xd lsm303md hscdtd006 qmc5983 akmd09911 bmm056
...
CUSTOM_HAL_SUB_IMGSENSOR= imx132_mipi_raw
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR = ov2680_mipi_raw gc2355_mipi_raw
...
CUSTOM_KERNEL_ALSPS = stk3310_auto tmd2772_auto
...
DIABLOXPLUS_KK_BMX050_SENSORS = yes
...
CUSTOM_KERNEL_IMGSENSOR= ov13850_mipi_raw imx135truly_mipi_raw imx135sunwin_mipi_raw imx135blx_mipi_raw imx132_mipi_raw ov2680_mipi_raw gc2355_mipi_raw
...
CUSTOM_KERNEL_LENS= ak7345af dw9718af dw9714a dw9714asunwin dummy_lens
...
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR= ov13850_mipi_raw imx135sunwin_mipi_raw imx135blx_mipi_raw

# lens driver config for main camera (2nd solution)
CUSTOM_KERNEL_MAIN_BACKUP_LENS=dw9718af dw9714a dw9714asunwin

# Kernel space image sensor driver:Main camera (rear camera) used sensor driver.Value is used main sensor name.
CUSTOM_KERNEL_MAIN_IMGSENSOR= imx135truly_mipi_raw

# lens driver config for main camera
CUSTOM_KERNEL_MAIN_LENS= ak7345af

# RTC driver customization
CUSTOM_KERNEL_RTC=rtc

# For audio kernel driver's speaker customization folder definition.
CUSTOM_KERNEL_SOUND=amp_6323pmic_spk_extdac_ES9018
...
CUSTOM_KERNEL_SUB_IMGSENSOR= imx132_mipi_raw
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR = ov2680_mipi_raw gc2355_mipi_raw
# lens driver config for video telephony camera
CUSTOM_KERNEL_SUB_LENS=dummy_lens

# touch driver  need to report correct touch axes
CUSTOM_KERNEL_TOUCHPANEL= bt541 mms244
JRD_CTP_ZINITIX_SUPPORT = yes
...
CUSTOM_LK_LCM = r63311_diabloX nt35596_tdt_diabloXplus nt35695_diabloX
...
#Modified yes to no by zonghua-jin for PR669624 begin
MTK_AUDIO_PROFILES=no
#Modified yes to no by zonghua-jin for PR669624 end
...
#add for diabloxplus feature build
SH_DIABLOXPLUS_SUPPORT=yes
...
# PR 689675 this project need custom xxhdpi resource so we need change the configuration of build to support xxhdpi
...
MTK_WEATHER3D_WIDGET=no #closed by tony app5 PR674434

# The weather information retrieval engine and provider.
MTK_WEATHER_PROVIDER_APP=no #closed by tony app5 PR674434

# A widget shows weather information provided by Yahoo!
MTK_WEATHER_WIDGET_APP=no #closed by tony app5 PR674434
...
CUSTOM_KERNEL_LCM = r63311_diabloX nt35596_tdt_diabloXplus nt35695_diabloX

# To choose uboot LCM driver name
#CUSTOM_UBOOT_LCM=hx8394a_hd720_dsi_vdo_tianma
CUSTOM_UBOOT_LCM = r63311_diabloX nt35596_tdt_diabloXplus nt35695_diabloX
...
#Added by jrd.hongyu.chu for over current protect issue
JRD_DIABLOXPLUS_OVER_CURRENT = yes
# [JRD.Blur] {{{
JRD_BLUR_SUPPORT=yes
# [JRD.Blur] }}}
#Added by jrd.lipeng for audio parameters customization(PR708145)
JRD_AUDIO_PARAMS_CUST_M = yes
