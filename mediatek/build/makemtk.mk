...
.PHONY : new newall remake remakeall clean cleanall \
         ...
         pregen preclean \
         update-api modem-info bindergen clean-modem check-seandroid perso
...
# Added by bin.wei.hz for jrd Customization 
MAKEPERSO    :=  make  $(MAKEJOBS) perso $(CMD_ARGU) $(MAKE_DEBUG)

#FR572310  added by yongming.li for show version begin
VERSIONDEF := development/version/include/version.inc
VERSIONLEN := 12
#FR572310  added by yongming.li for show version end 
...
# Deleted by jinming.xiang 2014.01.09 for 572370 
...
ifeq ($(ENABLE_TEE), TRUE)
  ...
  # Added by bin.wei.hz for jrd Customization begin
  ...
  # Added by bin.wei.hz for jrd Customization end
endif
...
#Modified Zhanying.Yang 2014/02/10 begin
javaoptgen: codegen
#Modified Zhanying.Yang 2014/02/10 end
