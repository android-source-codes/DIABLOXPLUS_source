...
my $SCAT_FILE = "$PRODUCT_OUT/$ArgList{PLATFORM}_Android_scatter_emmc.txt";
    ...
    else
    {
      #  $Partition_layout_xls = "$ptgen_location/partition_table_$ArgList{PLATFORM}.xls";
       ...
       if(-e $Partition_layout_xls)
        {
            print "The new partiton table is exist!\n" ;
        }
        else
        {
            print "Please add a new partition table form for new project!\n";
	     exit 1;
        }
