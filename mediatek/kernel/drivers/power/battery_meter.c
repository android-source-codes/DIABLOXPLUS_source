...
extern int byd_sucd_batt_id;
#endif

#ifdef DIABLOXPLUS_BATT_ID_SUPPORT
extern int hx_jn_batt_id;
#endif
...
kal_int32 fgauge_get_Q_max(kal_int16 temperature)
{
    ...
    if (temperature <= TEMPERATURE_T1)
    {
        ...
        #ifdef DIABLOXPLUS_BATT_ID_SUPPORT
			if (hx_jn_batt_id == 1) // HX
			{
				low_Q_max = HX_MAX_NEG_10;
				high_Q_max = HX_MAX_POS_0;
			}
			else if(hx_jn_batt_id == 2) // JN
			{
				low_Q_max = JN_MAX_NEG_10;
				high_Q_max = JN_MAX_POS_0;
			}
   else if (hx_jn_batt_id == 3)//SCUD
   {
    low_Q_max = SCUD_MAX_NEG_10;
				high_Q_max = SCUD_MAX_POS_0;
   }
   else if (hx_jn_batt_id == 4)//BYD
   {
     low_Q_max = BYD_MAX_NEG_10;
				 high_Q_max = BYD_MAX_POS_0;
   }
			else // default
			{
				low_Q_max = g_Q_MAX_NEG_10[g_fg_battery_id];
    ...
    else if (temperature <= TEMPERATURE_T2)
    {
        ...
        //high_Q_max = g_Q_MAX_POS_25[g_fg_battery_id];
			...
			if (hx_jn_batt_id == 1) // HX
			{
				low_Q_max = HX_MAX_POS_0;
				high_Q_max = HX_MAX_POS_25;
			}
			else if(hx_jn_batt_id == 2) // JN
			{
				low_Q_max = JN_MAX_POS_0;
				high_Q_max = JN_MAX_POS_25;
			}
   else if (hx_jn_batt_id == 3)//SCUD
   {
     low_Q_max = SCUD_MAX_POS_0;
			 	high_Q_max = SCUD_MAX_POS_25;
   }
   else if (hx_jn_batt_id == 4)//BYD
   {
     low_Q_max = BYD_MAX_POS_0;
			 	high_Q_max =BYD_MAX_POS_25;
    }
			else // default
			{
				low_Q_max = g_Q_MAX_POS_0[g_fg_battery_id];
    ...
    else
    {
        ...
        //high_Q_max = g_Q_MAX_POS_50[g_fg_battery_id];
			...
			if (hx_jn_batt_id == 1) // HX
			{
				low_Q_max = HX_MAX_POS_25;
				high_Q_max = HX_MAX_POS_50;
			}
			else if(hx_jn_batt_id == 2) // JN
			{
				low_Q_max = JN_MAX_POS_25;
				high_Q_max = JN_MAX_POS_50;
			}
   else if (hx_jn_batt_id == 3) // SCUD
   {
     low_Q_max = SCUD_MAX_POS_25;
				 high_Q_max = SCUD_MAX_POS_50;
    }
   else if (hx_jn_batt_id == 4) // BYD
   {
     low_Q_max = BYD_MAX_POS_25;
				 high_Q_max = BYD_MAX_POS_50;
   }
			else // default
			{
				low_Q_max = g_Q_MAX_POS_25[g_fg_battery_id];
...
kal_int32 fgauge_get_Q_max_high_current(kal_int16 temperature)
{
    ...
    if (temperature <= TEMPERATURE_T1)
    {
        ...
        //high_Q_max = g_Q_MAX_POS_0_H_CURRENT[g_fg_battery_id];
			...
			if (hx_jn_batt_id == 1) // HX
			{
				low_Q_max = HX_MAX_NEG_10_H_CURRENT;
				high_Q_max = HX_MAX_POS_0_H_CURRENT;
			}
			else if(hx_jn_batt_id == 2) // JN
			{
				low_Q_max = JN_MAX_NEG_10_H_CURRENT;
				high_Q_max = JN_MAX_POS_0_H_CURRENT;
			}
   else if (hx_jn_bat_id ==3)//SCUD
   {
     low_Q_max = SCUD_MAX_NEG_10_H_CURRENT;
     high_Q_max = SCUD_MAX_POS_0_H_CURRENT;
   }
   else if (hx_jn_bat_id ==4)//BYD
   {
      low_Q_max = BYD_MAX_NEG_10_H_CURRENT;
      high_Q_max = BYD_MAX_POS_0_H_CURRENT;
    }
			else // default
			{
				low_Q_max = g_Q_MAX_NEG_10_H_CURRENT[g_fg_battery_id];
    ...
    else if (temperature <= TEMPERATURE_T2)
    {
        ...
        //high_Q_max = g_Q_MAX_POS_25_H_CURRENT[g_fg_battery_id];
			...
			if (hx_jn_batt_id == 1) // HX
			{
				low_Q_max = HX_MAX_POS_0_H_CURRENT;
				high_Q_max = HX_MAX_POS_25_H_CURRENT;
			}
			else if(hx_jn_batt_id == 2) // JN
			{
				low_Q_max = JN_MAX_POS_0_H_CURRENT;
				high_Q_max = JN_MAX_POS_25_H_CURRENT;
			}
   else if(hx_jn_batt_id == 3)//SCUD
   {
     low_Q_max = SCUD_MAX_POS_0_H_CURRENT;
     high_Q_max = SCUD_MAX_POS_25_H_CURRENT;
    }
    else if(hx_jn_batt_id == 4)//BYD
   {
     low_Q_max = BYD_MAX_POS_0_H_CURRENT;
     high_Q_max = BYD_MAX_POS_25_H_CURRENT;
    }
			else // default
			{
				low_Q_max = g_Q_MAX_POS_0_H_CURRENT[g_fg_battery_id];
    ...
    else
    {
        ...
        //high_Q_max = g_Q_MAX_POS_50_H_CURRENT[g_fg_battery_id];
			...
			if (hx_jn_batt_id == 1) // HX
			{
				low_Q_max = HX_MAX_POS_25_H_CURRENT;
				high_Q_max = HX_MAX_POS_50_H_CURRENT;
			}
			else if(hx_jn_batt_id == 2) // JN
			{
				low_Q_max = JN_MAX_POS_25_H_CURRENT;
				high_Q_max = JN_MAX_POS_50_H_CURRENT;
			}
   else if(hx_jn_batt_id == 3) // SCUD
			{
				low_Q_max = SCUD_MAX_POS_25_H_CURRENT;
				high_Q_max = SCUD_MAX_POS_50_H_CURRENT;
			}
   else if(hx_jn_batt_id == 4) // BYD
			{
				low_Q_max = BYD_MAX_POS_25_H_CURRENT;
				high_Q_max = BYD_MAX_POS_50_H_CURRENT;
			}
			else // default
			{
				low_Q_max = g_Q_MAX_POS_25_H_CURRENT[g_fg_battery_id];
...
kal_int32 fgauge_get_Q_max(kal_int16 temperature)
{
    ...
    else if (temperature <= TEMPERATURE_T2)
    {
        ...
        high_temperature = TEMPERATURE_T2;
        #ifdef BATT_ID_CHECK_SUPPORT
        //	#if defined (YARIS_XL_FUEL_GUAGE)
	       if (byd_sucd_batt_id == 1)
	       {
...
#ifdef DIABLOXPLUS_BATT_ID_SUPPORT
    if (hx_jn_batt_id == 1) // HX
        return sizeof(hx_battery_profile_t2) / sizeof(BATTERY_PROFILE_STRUC);
    else if(hx_jn_batt_id == 2) // JN
        return sizeof(jn_battery_profile_t2) / sizeof(BATTERY_PROFILE_STRUC);
    else if (hx_jn_batt_id == 3) // SCUD
...
#ifdef DIABLOXPLUS_BATT_ID_SUPPORT
    if (hx_jn_batt_id == 1) // HX
        return sizeof(hx_r_profile_t2) / sizeof(BATTERY_PROFILE_STRUC);
    else if(hx_jn_batt_id == 2) // JN
        return sizeof(jn_r_profile_t2) / sizeof(BATTERY_PROFILE_STRUC);
    else if(hx_jn_batt_id == 3) // SCUD
        return sizeof(SCUD_r_profile_t2) / sizeof(BATTERY_PROFILE_STRUC);
    else if(hx_jn_batt_id == 4) // BYD
        return sizeof(BYD_r_profile_t2) / sizeof(BATTERY_PROFILE_STRUC);
   	else // default
...
BATTERY_PROFILE_STRUC_P fgauge_get_profile(kal_uint32 temperature)
{
	...
	#ifdef DIABLOXPLUS_BATT_ID_SUPPORT
			if (hx_jn_batt_id == 1) // HX
				return &hx_battery_profile_t0[0];
			else if(hx_jn_batt_id == 2) // JN
				return &jn_battery_profile_t0[0];
   else if(hx_jn_batt_id == 3) // SCUD
	...
	#ifdef DIABLOXPLUS_BATT_ID_SUPPORT
			if (hx_jn_batt_id == 1) // HX
				return &hx_battery_profile_t1[0];
			else if(hx_jn_batt_id == 2) // JN
				return &jn_battery_profile_t1[0];
   else if(hx_jn_batt_id == 3) // SCUD
	...
	#ifdef DIABLOXPLUS_BATT_ID_SUPPORT
			if (hx_jn_batt_id == 1) // HX
				return &hx_battery_profile_t2[0];
			else if(hx_jn_batt_id == 2) // JN
				return &jn_battery_profile_t2[0];
   else if(hx_jn_batt_id == 3) // SCUD
	...
	#ifdef DIABLOXPLUS_BATT_ID_SUPPORT
			if (hx_jn_batt_id == 1) // HX
				return &hx_battery_profile_t3[0];
			else if(hx_jn_batt_id == 2) // JN
				return &jn_battery_profile_t3[0];
   else if(hx_jn_batt_id == 3) // SCUD
...
#ifdef DIABLOXPLUS_BATT_ID_SUPPORT
	 if (hx_jn_batt_id == 1) // HX
			return &hx_r_profile_t0[0];
		else if(hx_jn_batt_id == 2) // JN
			return &jn_r_profile_t0[0];
  else if(hx_jn_batt_id == 3) // SCUD
...
#ifdef DIABLOXPLUS_BATT_ID_SUPPORT
		 if (hx_jn_batt_id == 1) // HX
			  return &hx_r_profile_t1[0];
	 	else if(hx_jn_batt_id == 2) // JN
			  return &jn_r_profile_t1[0];
   else if(hx_jn_batt_id == 3) // SCUD
...
#ifdef DIABLOXPLUS_BATT_ID_SUPPORT
		if (hx_jn_batt_id == 1) // HX
			return &hx_r_profile_t2[0];
		else if(hx_jn_batt_id == 2) // JN
			return &jn_r_profile_t2[0];
  else if(hx_jn_batt_id == 3)//SCUD
...
#ifdef DIABLOXPLUS_BATT_ID_SUPPORT
		if (hx_jn_batt_id == 1) // HX
			return &hx_r_profile_t3[0];
		else if(hx_jn_batt_id == 2) // JN
			return &jn_r_profile_t3[0];
  else if(hx_jn_batt_id == 3)//SCUD
...
#ifdef DIABLOXPLUS_BATT_ID_SUPPORT
    if (hx_jn_batt_id == 1) // HX
        return sizeof(hx_r_profile_t2) / sizeof(R_PROFILE_STRUC);
    else if(hx_jn_batt_id == 2) // JN
        return sizeof(jn_r_profile_t2) / sizeof(R_PROFILE_STRUC);
    else if(hx_jn_batt_id == 3) // SCUD
        return sizeof(SCUD_r_profile_t2) / sizeof(R_PROFILE_STRUC);
    else if(hx_jn_batt_id == 4) // BYD
        return sizeof(BYD_r_profile_t2) / sizeof(R_PROFILE_STRUC);
...
void dod_init(void)
{
    ...
    {
        if(((g_rtc_fg_soc != 0) && ((g_rtc_fg_soc-gFG_capacity_by_v) < CUST_POWERON_DELTA_CAPACITY_TOLRANCE) &&(( gFG_capacity_by_v > 0 || bat_is_charger_exist() == KAL_TRUE)))
    ...
    {
	    if(((g_rtc_fg_soc != 0) && ((gFG_capacity_by_v-g_rtc_fg_soc) < CUST_POWERON_DELTA_CAPACITY_TOLRANCE) &&(( gFG_capacity_by_v > 0 || bat_is_charger_exist() == KAL_TRUE)))
			|| ((g_rtc_fg_soc != 0) &&(g_boot_reason == BR_WDT_BY_PASS_PWK || g_boot_reason == BR_WDT || g_boot_reason == BR_TOOL_BY_PASS_PWK || g_boot_reason == BR_2SEC_REBOOT || g_boot_mode == RECOVERY_BOOT)))
        {
            gFG_capacity_by_v = g_rtc_fg_soc;            
        }
...
#if defined (JRD_FUEL_GAUGE_OPTIME)
    oam_r_1 +=10;
    oam_r_2 +=10;
    ...
    oam_i_2 = (((oam_v_ocv_2-vol_bat)*1000)*10) / oam_r_2;    //0.1mA
	 ...
	 if(gFG_Is_Charging == KAL_FALSE)
	 {
		 if (oam_d_2 < 15)
			if(oam_i_2 > 9000)
				vol_bat += 90;
			else if(oam_i_2 > 8000)
				vol_bat += 80;
			else if (oam_i_2 > 7000)
				vol_bat += 70;
			else if (oam_i_2 > 6000)
				vol_bat += 60;
			else if (oam_i_2 > 5000)
				vol_bat += 50;
			else if (oam_i_2 > 4000)
				vol_bat += 40;
			else if (oam_i_2 > 3000)
				vol_bat += 30;
			else
				vol_bat += 20;
		else if (oam_d_2 < 40)
			...
			if(oam_i_2 > 9000)
				...
				vol_bat -= 10;
		else if ((oam_d_2 < 85) &&(BMT_status.bat_vol > 3600))
			if(oam_i_2 > 9000)
				vol_bat -= 75;
			else if(oam_i_2 > 8000)
				vol_bat -= 65;
...
static ssize_t show_FG_Current(struct device *dev,struct device_attribute *attr, char *buf)
{
    ...
    */
    fg_current_inout_battery=battery_meter_get_battery_current();
