...
{
    COUNTRY_CODE_BS, COUNTRY_CODE_BB, COUNTRY_CODE_BO, COUNTRY_CODE_DM,
...
static const UINT_16     g_u2CountryGroup1[] =
{
    ...
    COUNTRY_CODE_CR, COUNTRY_CODE_MD, COUNTRY_CODE_NI, COUNTRY_CODE_PZ, COUNTRY_CODE_ZZ
};
...
{
    COUNTRY_CODE_UY, COUNTRY_CODE_MA
};
...
{
    COUNTRY_CODE_EU, COUNTRY_CODE_TR
...
DOMAIN_INFO_ENTRY arSupportedRegDomains[] = {
    ...
    },
    {
        ...
        (PUINT_16) g_u2CountryGroup15, sizeof(g_u2CountryGroup15) / 2,
        {
            ...
            { 115, BAND_5G,  CHNL_SPAN_20,  36,   4,  FALSE }, /* CH_SET_UNII_LOW_36_48 */
            { 118, BAND_5G,  CHNL_SPAN_20,  52,   4,  FALSE }, /* CH_SET_UNII_MID_52_64 */
            { 121, BAND_5G,  CHNL_SPAN_20, 100,   5,  FALSE }, /* CH_SET_UNII_WW_100_116 */
            { 121, BAND_5G,  CHNL_SPAN_20, 132,   3,  FALSE }, /* CH_SET_UNII_WW_132_140 */
            { 125, BAND_5G,  CHNL_SPAN_20, 149,   5,  FALSE }  /* CH_SET_UNII_UPPER_149_165 */
        }
    },
    {
        /* Note: This one is for CN. */
...
{
#define REG_DOMAIN_DEF_IDX          17  /* EU (Europe Union) */
