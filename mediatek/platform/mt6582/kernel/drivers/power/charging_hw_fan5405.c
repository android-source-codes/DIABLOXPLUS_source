...
#if 1
#include <cust_gpio_usage.h>
//[FR589935][[Battery Charge]updata battery charge driver] by [bin.song.hz] at [2014-2-8] begin
int gpio_number   = GPIO_CHG_DIS; 
int gpio_off_mode = GPIO_CHG_DIS_M_GPIO;
int gpio_on_mode  = GPIO_CHG_DIS_M_GPIO;
//[FR589935][[Battery Charge]updata battery charge driver] by [bin.song.hz] at [2014-2-8] end
#else
